...
def internship():
    ...
    st.title('Company, Student, and Mentor Details')
    ...
    st.write('Student Name: Kirit')
    st.write('Student ID: 12345')
    st.write('Program: Computer Science')
    st.write('University: Gujarat Technological University')
    st.write('Contact Email: student@example.com')

    # Mentor Details
    st.header('Mentor Details')
    st.write('Mentor Name: Chintan Nagrecha')
    st.write('Expertise: Data Science')
    st.write('Company: INFOLABZ IT SERVICES PVT. LTD.')
    st.write('Contact Email: info@infolabz.in')
